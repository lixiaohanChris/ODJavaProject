...
<head>
    ...
    <script src="backstagemanager/assets/js/courseContentAjax.js"></script>
</head>
									...
									<div class="am-fr">
					                	<ul class="am-pagination tpl-pagination">
					                    	<li>共有${pageData.totalCount }种课程</li>&nbsp;
					             			...
					             			<li id="page"></li>
					                   		<li><a class="PageButton" type="${courseId }" name="1">«</a></li>
					                   		<li><a class="toPage pre" type="${courseId }" name="1">上一页</a></li>
					                   		<c:if test="${pageData.totalPageNum<=5 }">
					                   			<c:forEach begin="1" end="${pageData.totalPageNum }" step="1" varStatus="p">
					                   				<li><a class="PageButton" type="${courseId }" name="${p.count }">${p.count }</a></li>                     
					                   			</c:forEach>
					                  		</c:if>
					                  		<c:if test="${pageData.totalPageNum>5 }">
								            ...
								            <li><a class="toPage next" type="${courseId }" name="2">下一页</a></li>
					     					<li><a class="PageButton" type="${courseId }" name="${pageData.totalPageNum }">»</a></li>
